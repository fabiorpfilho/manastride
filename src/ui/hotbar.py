...
class HotBar(Ui):
    ...
    def draw(self):
        ...
        hotbar_items = [
            {"icon": self.projectile_icon, "rect": pygame.Rect(start_x, start_y, self.box_size, self.box_size)},
            {"icon": self.dash_icon, "rect": pygame.Rect(start_x + self.box_size + self.box_spacing, start_y, self.box_size, self.box_size)},
            {"icon": self.shield_icon, "rect": pygame.Rect(start_x + (self.box_size + self.box_spacing) * 2, start_y, self.box_size, self.box_size)},
        ]
